...
### So, currently, GUJARAT is leading the tournament by winning eight matches. It is an achievement as a new team for Gujrat in IPL.It is an achievement as a new team for Gujrat in IPL. 
...
### So, currently, 26 matches are won while chasing the target, and 23 matches are won while defending the target.
...
### Currently, JOS BUTTLER has been a top scorer in 5 matches. He is looking in great form.

## 5. Analyze the runs scored by the top scorers
...
## 7. The best BOWLER of the most of the matches
...
## 8. Now let’s have a look at whether most of the wickets fall while setting the target or while chasing the target
